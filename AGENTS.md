...
This project is indexed by GitNexus as **ilink-hub** (6311 symbols, 13016 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
